    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('wall-panel')" :active="request()->routeIs('wall-panel')">
                        {{ __('Wall-panel') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('ceiling')" :active="request()->routeIs('ceiling')">
                        {{ __('Ceiling') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('packing')" :active="request()->routeIs('packing')">
                        {{ __('Packing') }}
                    </x-nav-link>
                </div>
            </div>
